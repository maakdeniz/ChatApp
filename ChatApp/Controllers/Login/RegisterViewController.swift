...
final class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Kayıt Ol",
                                                            style: .done,
                                                            target: self,
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                // user already exists
                strongSelf.alertUserLoginError(message: "Görünüşe göre bu e-posta adresi için bir kullanıcı hesabı zaten var.")
                return
            }

            FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password, completion: { authResult, error in
                guard authResult != nil, error == nil else {
                    print("Kullanıcıyı iyileştirme hatası")
                    return
                }
    ...
    func alertUserLoginError(message: String = "Yeni bir hesap oluşturmak için lütfen tüm bilgileri girin.") {
        ...
        alert.addAction(UIAlertAction(title:"Yoksay",
